...
#python bayesian_inference.py --shift=5 --path_1=../../test/drums/Track00001_1.wav --path_2=../../test/bass/Track00001_1.wav --restore_vqvae=../logs/lq_vae/checkpoint_step_19160_latent.pth.tar --restore_priors '../logs/prior_drums/checkpoint_latest.pth.tar' '../logs/pior_source/checkpoint_latest.pth.tar' --sum_codebook=../logs/codebook_precalc.pt --save_path ./data
